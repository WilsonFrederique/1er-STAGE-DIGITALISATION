...
<style>
    ...
    .dropdown-content2 a {
        ...
        display: block;
        text-align: left;
        min-width: 100%; /* La largeur minimum est égale à celle du conteneur parent */
    }
    ...
    .btn {
        ...
        width: 100%; /* Le bouton "Connexion" remplit la largeur de son conteneur */
    }

    .btn-top {
        width: 100%; /* Assurez-vous que ce bouton prend toute la largeur disponible */
    }

    .dropdown-content2 a {
        width: 100%; /* Alignement de la largeur des éléments de la liste */
